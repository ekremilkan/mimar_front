...
const Services = () => {
    ...
    const handleScroll = () => {
      if (sectionRef.current) {
        ...
        if (sectionTop < windowHeight && sectionBottom > 0) {
          ...
          setScrollPosition(scrolled * 0.15); // Orijinal değer korundu
        }
      }
    };
  ...
  return (
    <section
      ...
      style={{
        minHeight: "70vh", // 120vh'den 70vh'ye düşürüldü (sadece arka plan boyutu)
        marginTop: "-2rem", // Orijinal değer korundu
        paddingTop: "6rem", // Orijinal değere yakın
        paddingBottom: "4rem", // Biraz azaltıldı
      }}
    >
      <div
        ...
        style={{
          ...
          opacity: 0.7, // Arka plan opacity değeri azaltıldı (0.8'den 0.7'ye)
        }}
      >
        <div
          ...
          style={{
            ...
            opacity: 0.2, // Pattern opacity değeri azaltıldı (0.3'ten 0.2'ye)
          }}
        ></div>
      </div>
      ...
      <div className="relative max-w-7xl mx-auto px-4">
        ...
        <div className="relative">
          <Swiper
            modules={[Autoplay]}
            spaceBetween={24} // Orijinal değer korundu
            slidesPerView={1}
            loop={true}
            autoplay={{
              delay: 2500,
            ...
            className="pb-8" // Orijinal değer korundu
          >
